  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12">
        ...
        <div
          className={`mb-16 max-w-2xl transition-all delay-100 duration-700 ${
            isVisible
              ? "translate-y-0 opacity-100"
        ...
        <div className="relative min-h-[650px]">
          ...
          <div className="pointer-events-none absolute left-1/2 top-1/2 hidden h-[570px] w-[570px] -translate-x-1/2 -translate-y-1/2 md:block">
          ...
          <button
            ...
            className={`absolute left-0 top-[18%] z-30 hidden w-52 rounded-2xl border p-4 text-left backdrop-blur-xl transition-all duration-500 md:block ${
              activeProject === 0
          ...
          <button
            ...
            className={`absolute right-0 top-[25%] z-30 hidden w-52 rounded-2xl border p-4 text-left backdrop-blur-xl transition-all duration-500 md:block ${
              activeProject === 1
          ...
          <button
            ...
            className={`absolute bottom-[12%] left-[5%] z-30 hidden w-52 rounded-2xl border p-4 text-left backdrop-blur-xl transition-all duration-500 md:block ${
              activeProject === 2
          ...
          <div
            className={`absolute left-1/2 top-1/2 z-20 w-full max-w-[570px] -translate-x-1/2 -translate-y-1/2 transition-all duration-700 ${
              isVisible
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/[0.09] bg-[#0D1411]/95 shadow-[0_30px_100px_rgba(0,0,0,0.35)] backdrop-blur-xl">
              ...
              <div className="relative h-[250px] overflow-hidden md:h-[290px]">
                ...
                <div className="absolute inset-8 rounded-xl border border-white/[0.07] bg-[#101713]/80 p-5 shadow-2xl backdrop-blur-md">
                  ...
                  <div className="mt-7 grid grid-cols-3 gap-3">
                    ...
                    <div className="relative h-16 overflow-hidden rounded-lg border border-white/[0.06] bg-white/[0.025]">
                      <div className="absolute bottom-3 left-3 h-1.5 w-10 rounded-full bg-[#34E5A0]/30" />
                    </div>

                    <div className="relative h-16 overflow-hidden rounded-lg border border-white/[0.06] bg-white/[0.025]">
                      <div className="absolute bottom-3 left-3 h-1.5 w-12 rounded-full bg-[#6EE7F9]/30" />
                    </div>

                    <div className="relative h-16 overflow-hidden rounded-lg border border-white/[0.06] bg-white/[0.025]">
                      <div className="absolute bottom-3 left-3 h-1.5 w-8 rounded-full bg-[#A78BFA]/30" />
                    </div>
                ...
                <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center">
                  ...
                  <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-[#0A0F0D]/85 shadow-[0_0_40px_rgba(52,229,160,0.08)] backdrop-blur-xl">
          ...
          <div className="absolute bottom-0 left-0 right-0 grid grid-cols-3 gap-2 md:hidden">
