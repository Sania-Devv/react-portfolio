...
const projects = [
  {
    ...
    description:
      "A responsive website built during my software engineering trainee program, featuring clean layouts, modern UI sections, interactive components and a mobile-friendly experience.",
    technologies: ["HTML", "CSS", "JavaScript", "Bootstrap"],
    liveUrl:
      "https://sania-devv.github.io/Trainee-task1/index.html",
    githubUrl:
      "https://github.com/Sania-Devv/trainee-SE-Otech",
...

  {
    ...
    description:
      "A simple and interactive to-do list application built with JavaScript, allowing users to add, edit, update and manage daily tasks.",
    technologies: ["HTML", "CSS", "JavaScript"],
    liveUrl:
      "https://sania-devv.github.io/trainee-SE-To-do-List/",
    githubUrl:
      "https://github.com/Sania-Devv/trainee-SE-To-do-List",
...

  {
    ...
    description:
      "A responsive admin dashboard built with HTML, CSS and JavaScript, using a fake API to fetch and display dynamic data through an interactive dashboard interface.",
    technologies: ["HTML", "CSS", "JavaScript", "Fake API"],
    liveUrl:
      "https://sania-devv.github.io/adminDashboard/",
    githubUrl:
      "https://github.com/Sania-Devv/adminDashboard",
...

  {
    ...
    type: "Web Application",
    description:
      "A responsive weather application with multiple features for searching locations, viewing current weather conditions and exploring weather information through a clean and interactive interface.",
    technologies: ["HTML", "CSS", "JavaScript", "Weather API"],
    liveUrl:
      "https://sania-devv.github.io/weatherApp/",
    githubUrl:
      "https://github.com/Sania-Devv/weatherApp",
    accent: "from-[#6EE7F9] to-[#A78BFA]",
  },

  {
    ...
    description:
      "A full-stack food ordering application featuring a responsive React interface, interactive ordering functionality and a backend API for handling application data.",
    technologies: ["React", "JavaScript", "CSS", "REST API"],
    liveUrl:
      "https://trainee-se-food-ordering-system.vercel.app/",
    githubUrl:
      "https://github.com/Sania-Devv/trainee-SE-food-ordering-system",
    accent: "from-[#F59E0B] to-[#34E5A0]",
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12">
        ...
        <div className="relative lg:min-h-[650px]">
          ...
          <button
            ...
            className={`absolute left-0 top-[12%] z-30 hidden w-52 rounded-2xl border p-4 text-left backdrop-blur-xl transition-all duration-500 lg:block ${
              activeProject === 0
          ...
          <button
            ...
            className={`absolute right-0 top-[10%] z-30 hidden w-52 rounded-2xl border p-4 text-left backdrop-blur-xl transition-all duration-500 lg:block ${
              activeProject === 1
          ...
          {/* ================================================= */}
          {/* PROJECT 03 — BOTTOM LEFT                          */}
          {/* ================================================= */}

          <button
            onMouseEnter={() => setActiveProject(2)}
            onClick={() => setActiveProject(2)}
            className={`absolute bottom-[10%] left-[3%] z-30 hidden w-52 rounded-2xl border p-4 text-left backdrop-blur-xl transition-all duration-500 lg:block ${
              activeProject === 2
          ...
          {/* ================================================= */}
          {/* PROJECT 04 — BOTTOM RIGHT                         */}
          {/* ================================================= */}

          <button
            onMouseEnter={() => setActiveProject(3)}
            onClick={() => setActiveProject(3)}
            className={`absolute bottom-[10%] right-[3%] z-30 hidden w-52 rounded-2xl border p-4 text-left backdrop-blur-xl transition-all duration-500 lg:block ${
              activeProject === 3
                ? "border-[#6EE7F9]/40 bg-[#6EE7F9]/[0.07] shadow-[0_15px_50px_rgba(110,231,249,0.08)]"
                : "border-white/[0.07] bg-white/[0.02] hover:border-white/15"
            }`}
          ...
          {/* ================================================= */}
          {/* PROJECT 05 — TOP / LOWER CENTER                    */}
          {/* ================================================= */}

       {/* ================================================= */}
{/* PROJECT 05 — TOP CENTER                            */}
{/* ================================================= */}

<button
  onMouseEnter={() => setActiveProject(4)}
  onClick={() => setActiveProject(4)}
  className={`absolute left-1/2 top-[1%] z-30 hidden w-52 -translate-x-1/2 rounded-2xl border p-4 text-left backdrop-blur-xl transition-all duration-500 lg:block ${
    activeProject === 4
      ? "border-[#F59E0B]/40 bg-[#F59E0B]/[0.07] shadow-[0_15px_50px_rgba(245,158,11,0.08)]"
      : "border-white/[0.07] bg-white/[0.02] hover:border-white/15"
  }`}
>
  <div className="flex items-center justify-between">
  ...
  <p className="mt-1 text-[9px] uppercase tracking-wider text-white/25">
    {projects[4].type}
          ...
          <div className="relative z-20 mt-6 grid grid-cols-2 gap-2 sm:grid-cols-3 lg:hidden">
